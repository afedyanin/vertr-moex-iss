...
namespace MoexScreener.Components.Infrastructure;
public class CacheStorageAccessor(IJSRuntime js) : JSModule(js, "./_content/MoexScreener.Components/js/CacheStorageAccessor.js")
{
